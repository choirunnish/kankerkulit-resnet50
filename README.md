# Deteksi Penyakit Kanker Kulit pada Citra Dermoskopi Menggunakan Convolutional Neural Network dengan Arsitektur Residual Network 50
...
![Gambar 22](https://github.com/choirunnish/kankerkulit-resnet50/blob/master/assets/Picture7.png)
...
Setelah evaluasi model menggunakan Confusion Matrix, performa model CNN selanjutnya dianalisis menggunakan Classification Report yang
mencakup metriks akurasi, presisi, recall, dan f1-score untuk setiap kelas. Berikut adalah tabel Classification Report yang menunjukkan performa model berdasarkan perhitungan yang telah dijelaskan
...
Hasil Classification Report menunjukkan bahwa model menghasilkan nilai akurasi keseluruhan sebesar 77% artinya 77% prediksi model sesuai dengan data aslinya tetapi kalau dilihat lebih rinci berdasarkan nilai precision, recall, dan f1-score, performa model disetiap kelas berbeda-beda.

Precision atau tingkat ketepatan menunjukkan seberapa sering prediksi model untuk suatu kelas benar. Kelas dengan nilai precision tertinggi adalah VASC sebesar 92% dan NV sebesar 82% artinya prediksi model untuk kedua kelas ini jarang salah. Sebaliknya, kelas AK dan BKL memiliki nilai precision rendah masing-masing sebesar 53% dan 54% artinya model sering salah mengira kelas ini sebagai AK atau BKL.

Recall menunjukkan seberapa baik model mendeteksi semua kasus sebenarnya dalam suatu kelas. Kelas NV memiliki nilai recall tertinggi
sebesar 94% artinya hampir semua kasus NV berhasil terdeteksi tetapi nilai recall untuk kelas SCC hanya 35% artinya banyak kasus SCC yang tidak terdeteksi oleh model.

F1-score adalah kombinasi nilai precision dan recall yang memberikan gambaran performa keseluruhan untuk setiap kelas. Kelas NV memiliki nilai f1-score tertinggi sebesar 88% artinya model bekerja sangat baik untuk mendeteksi kelas ini. Selain itu, kelas BCC dan VASC juga memiliki performa cukup bagus dengan f1-score masing-masing sebesar 73% dan 76%. Model kesulitan mengenali kelas AK dan SCC yang terlihat dari nilai f1-score rendah masing-masing sebesar 49% dan 47%. Untuk kelas-kelas BKL, DF, dan MEL, nilai f1-score berada dikisaran 60%.

Secara keseluruhan, model ini sudah cukup baik dalam mendeteksi beberapa jenis kanker kulit tertentu yaitu kelas NV, BCC, dan VASC tetapi model masih perlu diperbaiki terutama untuk meningkatkan performa pada kelas-kelas yang sulit dideteksi kelas AK dan SCC.
...
![Gambar 4](https://github.com/choirunnish/kankerkulit-resnet50/blob/master/assets/Picture1.png)
...
![Gambar 5](https://github.com/choirunnish/kankerkulit-resnet50/blob/master/assets/Picture2.png)
