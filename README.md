...
Hasil Confusion Matrix menunjukkan bahwa model CNN mampu mengklasifikasikan delapan kelas kanker kulit dengan cukup baik. Model memiliki performa terbaik pada kelas NV, diikuti oleh MEL dan BCC, yang ditunjukkan oleh jumlah prediksi benar yang tinggi. Namun, masih terdapat kesalahan klasifikasi pada beberapa kelas, terutama AK, BKL, dan SCC, yang sering tertukar dengan kelas lain akibat kemiripan karakteristik citra. Kelas DF dan VASC menunjukkan performa sedang dengan jumlah data yang relatif lebih sedikit. Secara keseluruhan, model telah bekerja dengan baik pada kelas dominan, tetapi masih memerlukan peningkatan untuk meningkatkan akurasi pada kelas-kelas yang sulit dibedakan.
