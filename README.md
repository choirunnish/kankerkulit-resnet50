...
Hasil Confusion Matrix di atas menunjukkan prediksi model terhadap data aktual yang terbagi dalam delapan kelas yaitu AK, BCC, BKL, DF, MEL, NV, SCC, dan VASC. Untuk kelas AK, model berhasil memprediksi dengan benar sebanyak 79 data, namun ada 30 data yang salah dikategorikan sebagai BCC, 44 data yang salah dikategorikan sebagai BKL, serta beberapa kesalahan kecil lainnya. Untuk kategori BCC, model memiliki prediksi yang sangat baik dengan 467 data yang benar, namun ada 29 data yang salah diklasifikasikan sebagai AK dan 55 data yang salah sebagai BKL. Pada kelas BKL, model berhasil memprediksi 347 data dengan benar, meskipun terdapat 17 kesalahan yang dikategorikan sebagai AK dan 20 kesalahan sebagai BCC. Pada kelas DF, model berhasil mengidentifikasi 24 data dengan benar, meskipun ada 6 kesalahan yang diklasifikasikan sebagai BCC dan 11 kesalahan sebagai BKL. Kelas MEL menunjukkan hasil yang sangat baik dengan 488 data yang benar, tetapi ada beberapa kesalahan, seperti 15 data yang dikategorikan sebagai AK dan 22 data yang salah diklasifikasikan sebagai BCC. Untuk kelas NV, model berhasil mengidentifikasi 2411 data dengan benar, tetapi ada beberapa kesalahan yaitu 54 data yang salah dikategorikan sebagai MEL dan 86 data yang salah sebagai BKL. Model juga memiliki kesulitan dalam mendeteksi SCC dan VASC, dengan 44 kesalahan pada SCC dan 33 kesalahan pada VASC, meskipun secara keseluruhan jumlah prediksi yang benar cukup baik pada kedua kategori ini. Secara keseluruhan, model menunjukkan hasil yang baik pada beberapa kelas, seperti BCC, MEL, dan NV tetapi masih ada beberapa area yang perlu perbaikan, terutama dalam mengidentifikasi AK, SCC, dan BKL, yang menunjukkan banyak kesalahan klasifikasi.
